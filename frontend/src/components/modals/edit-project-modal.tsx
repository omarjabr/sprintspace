...
export function EditProjectModal({ id, mutate }: EditProjectModalProps) {
  const { data: project } = useFrappeGetDoc<Project>("Project", id);
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await updateDoc("Project", project.name, {
      // name,
      project_name: name,
      custom_bg,
    });
  ...
  useEffect(() => {
    setSelectedBg(project?.custom_bg || "");
  }, [project]);
      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={onSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>Edit this project</DialogDescription>
          </DialogHeader>
